...
U8 sci2c_WaitForStatusOkay(U32 msec);
...
#define GET_STATUS_MAX 70
    ...
    /* --- param exchange --- */
    // TODO: if activated it messes up the SE. Why?
    // https://www.nxp.com/docs/en/nxp/data-sheets/A71CLSDS.pdf
    // https://www.nxp.com/docs/en/supporting-information/AN12207.pdf#[{%22num%22%3A91%2C%22gen%22%3A0}%2C{%22name%22%3A%22XYZ%22}%2C148%2C292%2C0]
    ...
    int okay = sci2c_WaitForStatusOkay(APP_SCI2C_TIMEOUT_ms);
    if (!okay)
    {
